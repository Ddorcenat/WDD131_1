...
console.log("Activity 1 - simpleSort:", simpleSort);
...
console.log("Activity 1 - anotherSort:", anotherSort);
...
console.log('Activity 3 - search "yellowstone":', searchHikes(hikes, "yellowstone"));
